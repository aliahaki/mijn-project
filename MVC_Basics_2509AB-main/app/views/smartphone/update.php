        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="model" type="text" class="form-control" id="model" value="<?= $_POST['model'] ?? $data['smartphone']->Model ?>">
                </div>
                <div class="mb-3">
                    <label for="prijs" class="form-label">Prijs</label>
                    <input name="prijs" type="number" min="0" max="9999" step="0.01" class="form-control" id="prijs" value="<?= $_POST['prijs'] ?? $data['smartphone']->Prijs ?>">
                </div>
                <div class="mb-3">
                    <label for="geheugen" class="form-label">Geheugen (GB)</label>
                    <input name="geheugen" type="number" min="0" max="4096" class="form-control" id="geheugen" value="<?= $_POST['geheugen'] ?? $data['smartphone']->Geheugen ?>">
                </div>
                <div class="mb-3">
                    <label for="besturingssysteem" class="form-label">Besturingssysteem</label>
                    <input name="besturingssysteem" type="text" class="form-control" id="besturingssysteem" value="<?= $_POST['besturingssysteem'] ?? $data['smartphone']->Besturingssysteem ?>">
                </div>
                <div class="mb-3">
                    <label for="schermgrootte" class="form-label">Schermgrootte</label>
                    <input name="schermgrootte" type="number" min="0" max="10" step="0.01" class="form-control" id="schermgrootte" value="<?= $_POST['schermgrootte'] ?? $data['smartphone']->Schermgrootte ?>">
                </div>
                <div class="mb-3">
                    <label for="releasedatum" class="form-label">Releasedatum</label>
                    <input name="releasedatum" type="date" class="form-control" id="releasedatum" value="<?= $_POST['releasedatum'] ?? $data['smartphone']->Releasedatum ?>">
                </div>
                <div class="mb-3">
